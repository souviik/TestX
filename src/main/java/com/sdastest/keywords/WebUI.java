...
/**
 * This class that contains custom functions created for easy handling of elements and interactions on webpage Selenium and Java.
...
//            Assert.fail("❌ Timeout waiting for the element ready to click. " + by.toString());
    ...
    public static void waitForPageLoaded() {
        ...
        boolean jsReady = readyState != null && readyState.toString().equals("complete");
